...
Field Name | Format|Requirement| Details   | Additional Notes
-----------| ------| -------  |-----------|-----------------
collection_start_datetime|ISO 8601 date format (YYYY-MM-DD) or ISO 8601 datetime format (yyyy-mm-ddThh:mm:ss.ffffff)| Optional|Start date & time|Only required when the collector wants to sample populations within specific time frames e.g. between when a trap was set and when the sample was collected|
collection_end_datetime|ISO 8601 date format (YYYY-MM-DD) or ISO 8601 datetime format (yyyy-mm-ddThh:mm:ss.ffffff)| Required|Date  and hour of the data sample  collection |  The time the sample was collected. If collection occurs monthly use the first day of each month i.e. 2001-01-01, 2001-02-01. Date example: 2008-09-15, Datetime example: 2008-09-15T15:53:00|
